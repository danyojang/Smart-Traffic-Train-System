...
extern xTaskHandle xTrainComHandle;
	...
	pcText = strstr( c, "dir=" );
        ...
        if (strstr(pcInputString, "dir=e")) {
          fromState = 8;
        } else if (strstr(pcInputString, "dir=w")) {
          fromState = 4;
        } else if (strstr(pcInputString, "dir=s")) {
          fromState = 2;
        } else if (strstr(pcInputString, "dir=n")) {
          fromState = 1;
        }
